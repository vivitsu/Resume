...
including device detection, power management and data transfer. %\smallskip \\
%    \item Developed software components to manage the PCI bus, negotiate ownership with the 
%BIOS subsystem and added support for multiple vendor adapters, as part of the overall PXE application. %\smallskip \\
