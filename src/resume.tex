...
$\vardiamond$ vivitsu.maharaja@gmail.com $\vardiamond$ (352) 278-5449 $\vardiamond$ \texttt{https://github.com/vivitsu}
\end{center}
...
\begin{itemize}
  ...
  which powers all internal reporting and analytics.
    \item Developed \& maintained a web service using \textbf{Flask}, \textbf{uWSGI} \& \textbf{Tesseract} to automatically OCR documents
