...
%	PROJECT - 2
%---------------------
    \item Developed a software feature for that would allow multiple broadcast domains in a wireless router to form a VLAN (Virtual LAN).
\end{itemize}
%---------------------------------------------
%	          PROJECTS
%---------------------------------------------
...
Other projects include \textbf{Gossip based Topology Management in Peer-to-Peer Systems} \textit{using C}, \textbf{DNS Server} \textit{using Java RMI} \& \textbf{Totally-ordered Multicasting using Lamport logical clocks} \textit{using Java}. 
