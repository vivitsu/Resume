...
Implemented the T-Man gossip based topology management protocol for peer to peer overlay networks, which achieved various topologies for a cluster of nodes based on different distance functions. Used C.\\
...
\smallskip
\hrule
{\bf Programming Languages:} x86 Assembly, C, Java, Go, MPI, OpenMP, UPC, CUDA, Redis \& \LaTeX\ \\
